function taxForBracket(salary, previousTaxBracketMaxIncome, centsPerDollarOverFixedTax, fixedTaxForBracket) {
...
exports.calculateTax = function(salary){
    if(salary < 18201){
        ...
        return taxForBracket(salary, 18200, 0.19, 0);
    } else if(salary < 87001){
        return taxForBracket(salary, 37000, 0.325, 3572);
    } else if(salary < 180001){
        return taxForBracket(salary, 87000, 0.37, 19822);
    } else{
        return taxForBracket(salary, 180000, 0.45, 54232);
    }
};